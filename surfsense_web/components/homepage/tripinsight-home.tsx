...
const scenarios = [
	...
	},
	{
		...
		title: "游客反馈洞察",
		description:
			"聚合评论、视频、社区讨论和历史内容，识别高频诉求、槽点、趋势变化与潜在内容选题。",
	...
	},
	{
		...
		title: "目的地情报监控",
		description:
			"持续关注开放时间、预约政策、交通、价格和热门趋势，让重要变化自动进入研究工作台。",
	...
	return (
		<div className="min-h-screen bg-[#f7f8fa] text-zinc-950 dark:bg-zinc-950 dark:text-zinc-50">
			<header className="sticky top-0 z-50 border-b border-black/5 bg-[#f7f8fa]/90 backdrop-blur-xl dark:border-white/10 dark:bg-zinc-950/90">
				<div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-5 md:px-8">
					...
					<nav className="hidden items-center gap-7 text-sm text-zinc-600 md:flex dark:text-zinc-300">
						...
						<a href="#capabilities" className="transition hover:text-zinc-950 dark:hover:text-white">
							产品能力
						</a>
					</nav>
			...
			<main>
					...
					<div className="grid items-center gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:gap-16">
						<div>
							...
							<p className="mt-7 max-w-2xl text-base leading-8 text-zinc-600 md:text-lg dark:text-zinc-300">
								面向旅游内容、目的地运营与研究团队。TripInsight 将站内知识与开放网络实时信息结合，通过 AI
								Agent 完成目的地研究、游客反馈洞察、内容选题和持续情报监控。
							</p>
							...
							<div className="rounded-2xl border border-black/5 bg-[#fafafa] p-5 dark:border-white/10 dark:bg-zinc-950">
								...
								<div className="space-y-3 py-5">
									{[
										...
										<div key={source} className="flex items-center gap-3 rounded-xl border border-black/5 bg-white p-3 dark:border-white/10 dark:bg-zinc-900">
				...
				<section id="scenarios" className="border-y border-black/5 bg-white py-20 dark:border-white/10 dark:bg-zinc-900/40">
					<div className="mx-auto max-w-7xl px-5 md:px-8">
						<div className="max-w-2xl">
							<p className="text-sm font-medium text-zinc-500">核心业务场景</p>
							<h2 className="mt-3 text-3xl font-semibold tracking-[-0.03em] md:text-4xl">不是旅游聊天机器人，而是研究工作台</h2>
							<p className="mt-4 leading-7 text-zinc-600 dark:text-zinc-300">
								围绕旅游平台真实的信息研究与内容运营工作，把 Research、Knowledge、Insight 和 Automation 放在同一个工作区。
							</p>
						</div>
						...
						<div className="mt-10 grid gap-4 md:grid-cols-3">
							{scenarios.map((scenario) => {
								...
								return (
									<article key={scenario.title} className="rounded-2xl border border-black/10 bg-[#fafafa] p-6 dark:border-white/10 dark:bg-zinc-950">
										...
										<p className="mt-3 text-sm leading-6 text-zinc-600 dark:text-zinc-300">{scenario.description}</p>
										<p className="mt-5 border-t border-black/5 pt-4 text-xs leading-5 text-zinc-500 dark:border-white/10">{scenario.example}</p>
									</article>
								);
							})}
						</div>
				...
				<section id="workflow" className="mx-auto max-w-7xl px-5 py-20 md:px-8 md:py-24">
					<div className="grid gap-12 lg:grid-cols-[0.8fr_1.2fr] lg:items-center">
						<div>
							...
							<h2 className="mt-3 text-3xl font-semibold tracking-[-0.03em] md:text-4xl">从问题到可核验的 Destination Brief</h2>
							<p className="mt-5 leading-7 text-zinc-600 dark:text-zinc-300">
								让 Agent 负责理解问题、检索和分析；让知识库、数据源与引用系统负责提供可以被验证的证据。
							</p>
						</div>
						<div className="grid gap-3 sm:grid-cols-2">
							{researchSteps.map((step, index) => {
								...
								return (
									<div key={step.label} className="rounded-2xl border border-black/10 bg-white p-5 dark:border-white/10 dark:bg-zinc-900">
				...
				<section id="capabilities" className="border-y border-black/5 bg-zinc-950 py-20 text-white dark:border-white/10 dark:bg-black">
					<div className="mx-auto max-w-7xl px-5 md:px-8">
						<div className="max-w-2xl">
							<p className="text-sm font-medium text-zinc-400">产品能力</p>
							<h2 className="mt-3 text-3xl font-semibold tracking-[-0.03em] md:text-4xl">研究质量优先于功能堆叠</h2>
						</div>
				...
				<section className="mx-auto max-w-7xl px-5 py-20 md:px-8 md:py-24">
					<div className="rounded-3xl border border-black/10 bg-white px-6 py-12 text-center shadow-sm md:px-10 dark:border-white/10 dark:bg-zinc-900">
						...
						<h2 className="mx-auto mt-3 max-w-3xl text-3xl font-semibold tracking-[-0.03em] md:text-4xl">让旅游团队把时间花在判断上，而不是反复搜资料</h2>
